...
Pour le faire fonctionner, nous allons à présent le traduire en un programme informatique, et donc en modèle informatique.
...
J'ai muni mon programme d'une interface utilisateur simple, afin qu'il soit possible de l'utiliser sans connaissances en programmation.
