...
% XXX: Expliquer POURQUOI et COMMENT les modèles sont à la base de tout
...
Pourquoi, avec les immenses super-ordinateurs dont nous disposons, avec toute notre science, sommes-nous incapables de dire s'il pleuvra ou s'il fera beau le 18 janvier 2017 ?

Une réponse est que c'est impossible de la dire avec certitude, car soit il nous faudrait pour cela la connaissance universelle, soit rien n'est réellement prévisible même avec tout le savoir du monde :

\begin{quotation}
De deux choses l'une : soit toute chose est prévisible et nous manquons simplement du savoir nécessaire pour comprendre la Nature, soit certains phénomènes, comme la désintégration radioactive, ne sont pas seulement hors de notre portée mais réellement aléatoires, impossibles à prévoir, quelques avancées que nous fassions.

Dans le premier cas, \emph{toute cause a un effet}.
Rien n'est absolument isolé dans l'Univers.
On peut s'en rendre compte à l'échelle humaine : des choses apparemment anodines finissent souvent par avoir des conséquences inattendues, comme une invitation, une rencontre ou une offre d'emploi qui, plusieurs années plus tard, a fait prendre une tournure radicalement différente à la vie d'une personne.

Partant de cette hypothèse, \emph{tout dépend de tout}, et \textbf{il est donc nécessaire de tout connaître pour prédire quoi que ce soit} : l'Homme devrait alors posséder la connaissance universelle, et serait comme un dieu.
...
\small{Note : le lecteur ne sera probablement pas sans remarquer l'utilisation abondante de sources anglophones dans le présent TPE. % XXX
...
\clearpage
\section{Modélisation mathématique de l'irradiation solaire}
