...
\[
	\text{facteur de correction de l'heure} = 4 \left( \text{longitude} - \text{longitude du méridien local}) + \text{équation du temps} \right)
\]
...
On peut finalement calculer l'éclairement énergétique solaire :
