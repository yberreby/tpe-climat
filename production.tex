...
Je suis ainsi parvenu à construire un modèle mathématique de l'irradiation solaire, ainsi qu'un programme permettant de le faire fonctionner en réalisant automatiquement tous les calculs nécessaires. 
...
Ainsi, avec des connaissances et des moyens suffisants, on pourrait par exemple imaginer ajouter à ce modèle la prise en compte des nuages, qui absorbent beaucoup d'énergie solaire, ou de la courbure de la Terre\footnote{Le calcul de la masse d'air est en effet une simplification, qui considère le sol comme un plan et non comme la surface d'une sphère, ce qui entraîne de petites imprécisions.}.
On pourrait le rendre capable de prévoir la température dans une ville... mais il faudrait pour cela qu'il intègre l'effet de serre, les vents, le phénomène de convection atmosphérique, et mille autres données !
On se rend bien vite compte que la complexité du modèle augmente de façon exponentielle avec le nombre de facteurs qu'il prend en compte.
