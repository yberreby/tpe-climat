...
\small{Note : l'abondance des ressources écrites en anglais par rapport aux ressources françaises me poussa à mener mes recherches dans cette langue.}



\clearpage
\section{La modélisation informatique du climat}
...
\subsection{Le prévisible}

La science nous permet aujourd'hui de prévoir des phénomènes \emph{précisément à court terme}, ou \emph{approximativement à long terme}.
Ainsi, bien que nous puissions déclarer avec assurance que le temps sera couvert demain à midi, nous sommes incapables de dire quel temps il fera dans un an.
Pourquoi est-ce le cas ?
Pourquoi, avec les immenses super-ordinateurs dont nous disposons, avec toute notre science, sommes-nous incapables de dire s'il pleuvra ou s'il fera beau le
18 janvier 2017 ?

Une réponse est que c'est impossible de la dire avec certitude, car soit il nous faudrait pour cela la connaissance universelle, soit rien n'est réellement pr
évisible même avec tout le savoir du monde :

\begin{quotation}
De deux choses l'une : soit toute chose est prévisible et nous manquons simplement du savoir nécessaire pour comprendre la Nature, soit certains phénomènes, c
omme la désintégration radioactive, ne sont pas seulement hors de notre portée mais réellement aléatoires, impossibles à prévoir, quelques avancées que nous f
assions.

Dans le premier cas, \emph{toute cause a un effet}.
Rien n'est absolument isolé dans l'Univers.
On peut s'en rendre compte à l'échelle humaine : des choses apparemment anodines finissent souvent par avoir des conséquences inattendues, comme une invitatio
n, une rencontre ou une offre d'emploi qui, plusieurs années plus tard, a fait prendre une tournure radicalement différente à la vie d'une personne.

Partant de cette hypothèse, \emph{tout dépend de tout}, et \textbf{il est donc nécessaire de tout connaître pour prédire quoi que ce soit} : l'Homme devrait a
lors posséder la connaissance universelle, et serait comme un dieu.

Dans le second cas, s'il existe des phénomènes \emph{réellement} aléatoires, alors \textbf{rien ne peut être prédit car nulle chose n'est certaine}.
\end{quotation}

S'il nous est impossible de prédire quoi que ce soit, nous pouvons toutefois
...
% Plan de traitement :
% la masse d'air et l'atténuation par l'atmosphère, au coeur de tout

% l'inclinaison de la Terre, ou 'obliquité' (source CNRS)

% l'angle d'élévation et le calcul trigo qui permet de l'obtenir


\clearpage
\section{Modélisation mathématique : calcul d'éclairement énergétique}
...
\begin{figure}[!htp]
	\centerline{\includegraphics[width=\paperwidth]{graph.png}}
