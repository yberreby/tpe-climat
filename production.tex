...
Plus la distance qu'ils parcourent au travers de l'atmosphère est grande, plus ils perdent d'énergie, et cette distance est d'autant plus grande que les rayons solaires suivent une trajectoire inclinée, c'est-à-dire que leur angle d'incidence est grand.
Cet angle est appelé \emph{angle zénithal}.

 \begin{figure}[H]
	\centerline{\includegraphics[width=12cm]{angle-of-incidence.jpg}}
	\caption{L'angle d'incidence des rayons lumineux est appelé \emph{angle zénithal}.}
