...
Nous disposons à présent d'un petit modèle climatique. Pour le faire fonctionner, nous allons à présent le traduire en un programme informatique, et donc en modèle informatique.
...
Il existe de nombreux langages de programmation, chacun ayant ses propres atouts et points faibles. Pour ce TPE, j'ai choisi d'écrire mon programme en \textbf{Rust} \cite{rust}. Il s'agit d'un langage innovant, extrêmement performant, et prévenant de nombreux bugs grâce à un système qui analyse automatiquement le code source afin de vérifier son exactitude avant la traduction en langage machine. Ce sont ces qualités, ainsi que ma familiarité avec le langage -- je l'utilise en effet depuis janvier 2015 -- qui ont motivé mon choix.
...
Il est également possible de le lire directement depuis votre navigateur, en cliquant sur les noms des fichiers dans l'interface Web. Le code est dans \texttt{src}.
