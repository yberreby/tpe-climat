...
J'ai fait fonctionner mon programme avec divers paramètres jusqu'à obtenir un éclairement énergétique solaire maximal.
Par définition, ce maximum est atteint lorsque la masse d'air est égale à $1$, mais en pratique, on va chercher à la faire \emph{tendre} vers cette valeur.
