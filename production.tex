...
\begin{figure}[!ht]
  \centering
      \makebox[\textwidth]{\includegraphics[width=15cm]{demonstration-programme.png}}
...
Vous pouvez en télécharger une copie sur votre disque dur en cliquant sur "Download ZIP" dans l'interface GitHub, ou sur le lien suivant : \url{https://github.com/yberreby/rust-climate/archive/master.zip}.
...
Si vous souhaitez le faire fonctionner par vous-même, il devrait vous être possible de compiler et d'exécuter \texttt{rust-climate} après avoir installé le compilateur Rust \cite{rust_install}.

[XXX: faudrait-il des instructions précises pour les utilisateurs Windows ?]
