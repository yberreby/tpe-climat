...
Une réponse possible est que la nature est bien trop complexe pour la modéliser dans son entièreté.
J'en veux pour preuve le raisonnement suivant :

Admettons que nous puissions prévoir le temps qu'il fera à n'importe quelle date dans le futur, et à n'importe quel endroit sur Terre.
Rien n'est absolument isolé dans l'Univers ; même l'évènement le plus lointain et le plus infime peut toujours influer sur l'issue d'un autre évènement.
On peut s'en rendre compte à l'échelle humain : des choses apparemment anodines finissent souvent par avoir des conséquences inattendues.
En effet, qui ne s'est jamais demandé, en revenant sur son passé, ce qu'il se serait passé s'il n'avait pas accepté telle invitation, rencontré telle personne ou pris tel emploi ?
Les choses auraient-elles été différentes si une seule de ces choses n'était pas arrivée ?
